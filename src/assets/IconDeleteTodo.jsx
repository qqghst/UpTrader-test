...
const IconDeleteTodo = () => {
    return (
        <div>
            <svg className='w-[16px] h-[16px] fill-black cursor-pointer' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
